...
execute as @a[scores={deathbolt=1..}] run function spells:spells/necro/earlyspells/level1/deathbolt/givespell
execute as @a[scores={raiseundead=1..}] run function spells:spells/necro/earlyspells/level1/raiseundead/givespell
execute as @a[scores={raisedeathknight=1..}] run function spells:spells/necro/earlyspells/level2/raisedeathknight/givespell
execute as @a[scores={witheringplague=1..}] run function spells:spells/necro/earlyspells/level2/witheringplague/givespell
execute as @a[scores={diseaseweapon=1..}] run function spells:spells/necro/earlyspells/level3/diseaseweapon/givespell
execute as @a[scores={deathgate=1..}] run function spells:spells/necro/earlyspells/level3/deathgate/givespell
execute as @a[scores={entomb=1..}] run function spells:spells/necro/entomb/givespell

execute as @a[scores={graveblast=1..}] run function spells:spells/necro/necromancer/level4/graveblast/givespell
execute as @a[scores={raisegraveassassin=1..}] run function spells:spells/necro/necromancer/level4/raisegraveassassin/givespell
execute as @a[scores={graveyard=1..}] run function spells:spells/necro/necromancer/level5/graveyard/givespell
execute as @a[scores={blightrain=1..}] run function spells:spells/necro/necromancer/level5/blightrain/givespell
execute as @a[scores={elderlich=1..}] run function spells:spells/necro/necromancer/level6/elderlich/givespell

execute as @a[scores={cursedpunch=1..}] run function spells:spells/necro/plagueknight/level4/cursedpunch/givespell
execute as @a[scores={spitbile=1..}] run function spells:spells/necro/plagueknight/level4/spitbile/givespell
execute as @a[scores={blightedblade=1..}] run function spells:spells/necro/plagueknight/level5/blightedblade/manacooldown
execute as @a[scores={wakeofdeath=1..}] run function spells:spells/necro/plagueknight/level5/wakeofdeath/givespell
execute as @a[scores={abomination=1..}] run function spells:spells/necro/plagueknight/level6/abomination/givespell

execute as @a[scores={dismissundead=1..}] run function spells:spells/necro/dismissundead

execute as @a[scores={necrotitle1=1..}] run function spells:spells/necro/titles/level1
execute as @a[scores={necrotitle2=1..}] run function spells:spells/necro/titles/level2
execute as @a[scores={necrotitle3=1..}] run function spells:spells/necro/titles/level3
execute as @a[scores={necrotitle4=1..}] run function spells:spells/necro/titles/necromancer4
execute as @a[scores={necrotitle5=1..}] run function spells:spells/necro/titles/necromancer5
execute as @a[scores={necrotitle6=1..}] run function spells:spells/necro/titles/necromancer6
execute as @a[scores={necrotitle7=1..}] run function spells:spells/necro/titles/plagueknight4
execute as @a[scores={necrotitle8=1..}] run function spells:spells/necro/titles/plagueknight5
execute as @a[scores={necrotitle9=1..}] run function spells:spells/necro/titles/plagueknight6
