...
function spells:loops/spells/fire/earlyspells/level2/heatwave/loop
function spells:loops/spells/fire/earlyspells/level3/flameblade/loop
function spells:loops/spells/fire/earlyspells/level3/jet/loop
