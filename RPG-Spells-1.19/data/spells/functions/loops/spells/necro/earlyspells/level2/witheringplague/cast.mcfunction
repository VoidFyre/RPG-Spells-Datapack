execute as @a[tag=castwitheringplague,scores={cast_time=0}] at @s run function spells:spells/necro/earlyspells/level2/witheringplague/witheringplague
...
execute as @e[type=!item,tag=!phylactery,tag=!abomiation_egg,scores={plaguespread=1}] at @s run function spells:spells/necro/earlyspells/level2/witheringplague/witheringplague