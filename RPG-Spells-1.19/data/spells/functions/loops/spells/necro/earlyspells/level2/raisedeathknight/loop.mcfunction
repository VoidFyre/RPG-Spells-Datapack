execute as @e[type=item,nbt={Item:{tag:{raisedeathknight_kill:1}}}] at @s run function spells:loops/spells/necro/earlyspells/level2/raisedeathknight/kill
