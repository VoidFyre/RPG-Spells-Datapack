...
execute as @a[tag=deathtransportingab] at @s if entity @e[tag=deathgateone,distance=..1] run execute as @e[tag=deathgateone,limit=1,sort=nearest] run function spells:loops/spells/necro/earlyspells/level3/deathgate/findgatetwo
execute as @a[tag=deathtransportingba] at @s if entity @e[tag=deathgatetwo,distance=..1] run execute as @e[tag=deathgatetwo,limit=1,sort=nearest] run function spells:loops/spells/necro/earlyspells/level3/deathgate/findgateone
