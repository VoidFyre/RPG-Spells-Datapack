...
execute as @e[tag=spitbilespell,tag=in_motion] at @s if entity @e[type=!item,distance=..2] run function spells:spells/necro/plagueknight/level4/spitbile/spitbile
