execute as @e[type=item,nbt={Item:{id:"minecraft:flint",tag:{elder_lich_spawner:1}}}] at @s run function spells:loops/bosses/necro/summonelderlich
...
execute as @e[type=skeleton,tag=elder_lich] at @s if score @s elderlichcooldown matches 0 run function spells:loops/bosses/necro/elderlichcast
