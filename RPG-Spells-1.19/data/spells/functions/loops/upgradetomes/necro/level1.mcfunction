...
kill @e[distance=...5,type=item,nbt={Item:{id:"minecraft:rotten_flesh",tag:{rotten_paper:1}}}]

execute as @p run function spells:spells/necro/grantlevels/grantlevel1