...
execute as @e[sort=nearest,limit=1,tag=devour] if score @s undead matches 0 if score @s devourcount matches 5 unless score @s abominationduration matches 1101.. run scoreboard players add @s abominationduration 100
execute as @e[sort=nearest,limit=1,tag=devour] if score @s undead matches 0 if score @s devourcount matches 4 unless score @s abominationduration matches 1121.. run scoreboard players add @s abominationduration 80
execute as @e[sort=nearest,limit=1,tag=devour] if score @s undead matches 0 if score @s devourcount matches 3 unless score @s abominationduration matches 1141.. run scoreboard players add @s abominationduration 60
execute as @e[sort=nearest,limit=1,tag=devour] if score @s undead matches 0 if score @s devourcount matches 2 unless score @s abominationduration matches 1161.. run scoreboard players add @s abominationduration 40
execute as @e[sort=nearest,limit=1,tag=devour] if score @s undead matches 0 if score @s devourcount matches 1 unless score @s abominationduration matches 1181.. run scoreboard players add @s abominationduration 20