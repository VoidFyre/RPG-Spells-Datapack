...
summon minecraft:wolf ~ ~-1 ~ {Attributes:[{Name:generic.max_health,Base:30.0f},{Name:generic.movement_speed,Base:0.5f},{Name:generic.attack_damage,Base:20.0f}],Health:30.0f,CustomName:"\"Grave Assassin\"",Silent:1,Tags:["getplayer","summonedBase","summonedGA"],ActiveEffects:[{Id:14,Amplifier:0,Duration:999999}]}
