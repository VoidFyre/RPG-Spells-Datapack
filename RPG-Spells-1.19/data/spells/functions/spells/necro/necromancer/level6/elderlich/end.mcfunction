...
execute as @e[type=armor_stand,tag=store_armor] if score @s summoncounter = @p[tag=store_armor] trackplayers run function spells:spells/armorstorage/restorearmor
