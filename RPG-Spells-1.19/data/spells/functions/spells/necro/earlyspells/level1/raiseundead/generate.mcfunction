...
execute at @s anchored feet positioned ^-2 ^ ^ run summon zombie ~ ~-2 ~ {DeathLootTable:"minecraft:empty",NoAI:1,Tags:["zombieProxy"],Invulnerable:1,HandItems:[{Count:1,id:iron_sword},{}],ArmorItems:[{Count:1,id:chainmail_boots},{Count:1,id:chainmail_leggings},{Count:1,id:chainmail_chestplate},{Count:1,id:chainmail_helmet}],CustomName:"\"Raised Undead\""}
