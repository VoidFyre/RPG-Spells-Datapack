...
execute at @s anchored feet positioned ^-2 ^ ^ run summon minecraft:item ~ ~ ~ {Power:[0.0,-0.1,0.0],Motion:[0.0,0.1,0.0],NoGravity:1b,Item:{id:"minecraft:zombie_head",Count:1b},Age:5950,PickupDelay:9999,Tags:["conjurenetherhoundspell","summon_spell"]}

execute at @s anchored feet positioned ^-2 ^ ^ run summon zombie ~ ~-2 ~ {DeathLootTable:"minecraft:empty",NoAI:1,Tags:["summonProxy","netherhoundProxy"],Invulnerable:1,HandItems:[{Count:1,id:iron_sword},{}],ArmorItems:[{Count:1,id:chainmail_boots},{Count:1,id:chainmail_leggings},{Count:1,id:chainmail_chestplate},{Count:1,id:chainmail_helmet}],CustomName:"\"Raised Undead\""}
