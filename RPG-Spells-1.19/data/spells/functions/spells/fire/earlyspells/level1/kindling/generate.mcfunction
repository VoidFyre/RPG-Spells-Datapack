...
execute as @e[distance=..10,type=!item,type=!item_frame,type=!armor_stand,type=!area_effect_cloud] at @a run function spells:spells/fire/earlyspells/level1/kindling/kindling