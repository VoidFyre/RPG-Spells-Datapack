...
execute as @e[type=!armor_stand,type=!item,type=!item_frame,distance=..3] at @s run setblock ~ ~ ~ fire
execute as @e[type=!armor_stand,type=!item,type=!item_frame,distance=..3] at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,NoGravity:1b,Tags:["extinguish"]}
