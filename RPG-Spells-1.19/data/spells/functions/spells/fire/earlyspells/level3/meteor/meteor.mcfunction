...
execute as @e[distance=..10,type=!armor_stand,type=!item,type=!item_frame,tag=!Summoned,tag=!summonedFireBase] run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,NoGravity:1b,Tags:["extinguish"]}
execute as @e[distance=..10,type=!armor_stand,type=!item,type=!item_frame,tag=!Summoned,tag=!summonedFireBase] run setblock ~ ~ ~ fire
execute as @e[distance=..10,type=!armor_stand,type=!item,type=!item_frame,tag=!Summoned,tag=!summonedFireBase] run data merge entity @s {Fire:320}
