...
#demonologist scoreboards
scoreboard objectives add conjureimpcooldown dummy
scoreboard objectives add netherflameboltcooldown dummy
scoreboard objectives add conjuredemoncooldown dummy
scoreboard objectives add netherstormcooldown dummy
scoreboard objectives add demonlordcooldown dummy
scoreboard objectives add darkpactcooldown dummy

#transport scoreboards
scoreboard objectives add firetransportab dummy
scoreboard objectives add firetransportba dummy
scoreboard objectives add firetransportcd dummy

#hardcore resurrection scoreboard
scoreboard objectives add phoenixrebirthcooldown dummy

#boss duration scoreboards
scoreboard objectives add magmalordduration dummy
scoreboard objectives add demonlordduration dummy

#spell duration scoreboards
scoreboard objectives add heatwaveduration dummy
scoreboard objectives add meteorduration dummy
scoreboard objectives add firecoreduration dummy