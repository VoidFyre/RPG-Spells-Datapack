...
execute as @a[tag=firetransportingab] at @s if entity @e[tag=firegateone,distance=..1] run execute as @e[tag=firegateone,limit=1,sort=nearest] run function rpg:spells/fire/earlyspells/level3/netherwalk/loop/findgatetwo
execute as @a[tag=firetransportingba] at @s if entity @e[tag=firegatetwo,distance=..1] run execute as @e[tag=firegatetwo,limit=1,sort=nearest] run function rpg:spells/fire/earlyspells/level3/netherwalk/loop/findgateone
