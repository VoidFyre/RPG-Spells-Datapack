...
execute as @e[tag=firecorespell,tag=in_motion] at @s if entity @e[type=!item,distance=..2] run function rpg:spells/fire/flameknight/level4/firecore/trigger/firecore
