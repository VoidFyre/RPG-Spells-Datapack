...
execute as @a[scores={mana=150..},tag=meteorflying,nbt={FallFlying:1b,SelectedItem:{id:"minecraft:firework_rocket",Count:2b,tag:{meteorspell:1b}}}] run function spells:loops/spells/fire/flameknight/level4/meteor/refillmainhand

execute as @a[scores={mana=150..},tag=meteorflying,nbt={FallFlying:1b,Inventory:[{Slot:-106b,id:"minecraft:firework_rocket",Count:2b,tag:{meteorspell:1b}}]}] run function spells:loops/spells/fire/flameknight/level4/meteor/refilloffhand
...
execute as @a[tag=!meteorflying,tag=meteorstrike,scores={usedrocket=1..},nbt={FallFlying:0b}] at @s run function spells:spells/fire/flameknight/level4/meteor/meteor