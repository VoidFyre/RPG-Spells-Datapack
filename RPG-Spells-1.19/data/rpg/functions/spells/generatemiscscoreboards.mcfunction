...
scoreboard objectives add usedwoodensword minecraft.used:minecraft.wooden_sword
scoreboard objectives add usedstoneaxe minecraft.used:minecraft.stone_axe
scoreboard objectives add usedstonesword minecraft.used:minecraft.stone_sword
scoreboard objectives add usedironaxe minecraft.used:minecraft.iron_axe
scoreboard objectives add usedironsword minecraft.used:minecraft.iron_sword
