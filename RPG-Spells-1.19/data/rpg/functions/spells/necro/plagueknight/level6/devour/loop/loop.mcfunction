...
execute as @e[scores={devourduration=120}] at @s run execute as @e[distance=..6,tag=!devour,limit=5] run function spells:spells/necro/plagueknight/level6/devour/devour
execute as @e[scores={devourduration=80}] at @s run execute as @e[distance=..6,tag=!devour,limit=5] run function spells:spells/necro/plagueknight/level6/devour/devour
execute as @e[scores={devourduration=40}] at @s run execute as @e[distance=..6,tag=!devour,limit=5] run function spells:spells/necro/plagueknight/level6/devour/devour
