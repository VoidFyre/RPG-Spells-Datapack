...
summon minecraft:wolf ~ ~-2.5 ~ {Attributes:[{Name:generic.max_health,Base:200.0f}],Health:200.0f,CustomName:"\"Raised Death Knight\"",Silent:1,Tags:["getplayer","summonedDeathBase","summonedDeathKnight"],ActiveEffects:[{Id:5,Amplifier:2,Duration:999999},{Id:11,Amplifier:2,Duration:999999},{Id:12,Amplifier:0,Duration:999999},{Id:14,Amplifier:0,Duration:999999}]}
