...
execute as @e[distance=..5] if score @s plagueimmunity matches 0 run effect give @s wither 4 2 true
execute as @e[distance=..5] if score @s plagueimmunity matches 0 run scoreboard players set @s plaguespread 80
