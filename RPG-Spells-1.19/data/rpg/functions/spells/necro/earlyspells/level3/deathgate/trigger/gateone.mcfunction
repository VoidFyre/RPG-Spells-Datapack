...
execute as @e[tag=deathgateone] at @s if score @s summoncounter = @p trackplayers run function spells:spells/detectchunkloaders
...
execute as @e[tag=deathgateone] at @s if score @s summoncounter = @p trackplayers run function spells:spells/chunkloader
