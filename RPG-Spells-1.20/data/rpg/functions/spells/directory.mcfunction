...
execute if score @s element matches 1 run function rpg:spells/necro/directory
execute if score @s element matches 2 run function rpg:spells/fire/directory