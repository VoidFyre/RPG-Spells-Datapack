...
execute as @e[tag=firegatetwo] at @s if score @s summoncounter = @p trackplayers run function rpg:spells/detectchunkloaders
...
execute as @e[tag=firegatetwo] at @s if score @s summoncounter = @p trackplayers run function rpg:spells/chunkloader
