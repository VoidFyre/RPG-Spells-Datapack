...
execute as @e[type=minecraft:zombie,tag=phylactery,sort=nearest] if score @s summoncounter = @a[tag=usedphylactery,limit=1] trackplayers if score @s count_phylactery matches 1 run function rpg:spells/detectchunkloaders
